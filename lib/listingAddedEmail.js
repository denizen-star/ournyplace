...
function buildListingDetailEmailHtml({ apartment, criteria, publicBaseUrl, kind, manual }) {
  ...
  const scorecardFullyScored =
    isScoresComplete &&
    isBothPartnersVotingComplete(Array.isArray(criteria) ? criteria : [], apartment.ratings || {});
  ...
  if (!isScoresComplete) {
    ...
    h1 = 'Scoring complete';
    intro = 'Peter and Kerv have scored every criterion. The combined average (Avg) is ready.';
  } else {
